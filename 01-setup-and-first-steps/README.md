...
| Command | What It Does |
|---------|--------------|
| `/autopilot [objective]` (or `/goal [objective]`) | Switch to autopilot mode; optionally provide a specific objective to keep Copilot focused on that task |
